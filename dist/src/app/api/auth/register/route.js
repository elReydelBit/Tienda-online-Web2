...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, username, email, password, existingUser, hashedPassword, user, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), username = _a.username, email = _a.email, password = _a.password;
                ...
                case 2:
                    ...
                    if (existingUser) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'El usuario o email ya existe.' }, { status: 409 })];
                    }
