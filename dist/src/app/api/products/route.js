...
var prisma_1 = __importDefault(require("@/lib/prisma")); // Asegúrate de que esta ruta sea correcta
function GET() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ message: 'Error al obtener productos' }, { status: 500 })];
